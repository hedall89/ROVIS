...
if yellow >= Green and yellow >= Blue and yellow >= Red:
    print("Gul er den største")
elif Green >= Blue and Green >= Red:
    print("Grøn er den største")
elif Red >= Blue:
    print("Rød er den største")
else:
    print("Blå er den største")
