...
mask_Hori = np.array(([-1,-1,-1],
                      [0,0,0],
                      [1,1,1]))
mask_Hori2 = np.array(([-1,-1,-1],
                      [0,0,0],
                      [1,1,1]))*-1
img_Vertical_filter = cv2.filter2D(copy_img, -1, mask_Hori)
img_Horizontal_filter = cv2.filter2D(copy_img, -1, mask_Vert)
img_Vertical_filter2 = cv2.filter2D(copy_img, -1, mask_Hori2)
img_Horizontal_filter2 = cv2.filter2D(copy_img, -1, mask_Vert2)
